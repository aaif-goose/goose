...
test-buzz:
    ...
    for file in buzz/assign_pr_maintainers buzz/create_github_manager buzz/create_issue_channel buzz/list_issue_work buzz/syncissues buzz/github_manager.mjs; do node --check "$file"; done
