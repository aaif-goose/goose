...
const SETUP_METADATA: &[CuratedSetupMetadata] = &[
    ...
    CuratedSetupMetadata {
        ...
        group: ProviderSetupGroup::Additional,
        display_name: None,
        description: Some("Grok models via xAI API key or OAuth"),
        docs_url: Some("https://docs.x.ai/docs/overview"),
        aliases: &["grok", "supergrok", "x premium"],
        native_connect_query: Some("xAI"),
        binary_name: None,
        setup_capabilities: setup_capabilities(false, true, false),
        show_only_when_installed: false,
        synthetic: false,
