...
#[request(method = "_goose/v1/session/extensions/add", response = EmptyResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/tools/list", response = GetToolsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/resources/read", response = ReadResourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/tools/call", response = GooseToolCallResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/working-dir/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/config/extensions/list", response = GetExtensionsResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/config/extensions/add", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/config/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/config/extensions/toggle", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/extensions/list", response = GetSessionExtensionsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/preferences/read", response = PreferencesReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/preferences/save", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/preferences/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/defaults/read", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/defaults/save", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/onboarding/import/scan",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/onboarding/import/apply",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/secret/save", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/secret/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/project/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
/// Rename a session.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/rename", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/archive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/unarchive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/export", response = ExportSessionResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/session/import", response = ImportSessionResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/config/read",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/config/status",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/config/save",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/config/delete",
    response = ProviderConfigChangeResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/config/authenticate",
    response = ProviderConfigChangeResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/catalog/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/setup/catalog/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/catalog/template",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/custom/create",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/custom/read",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/custom/update",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/custom/delete",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/sources/create", response = CreateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
/// skills.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/sources/list", response = ListSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/sources/update", response = UpdateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/sources/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/sources/export", response = ExportSourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/sources/import", response = ImportSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/transcribe", response = DictationTranscribeResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/config", response = DictationConfigResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/providers/list", response = ListProvidersResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/providers/inventory/refresh",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/dictation/models/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/models/download", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_goose/v1/dictation/models/download/progress",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/models/cancel", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/models/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_goose/v1/dictation/models/select", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
