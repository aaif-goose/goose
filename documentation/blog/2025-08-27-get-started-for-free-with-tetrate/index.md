...
:::tip Protip 
 Want the best of both worlds? Use a dedicated planner model for complex strategy and a faster default model for execution. Pair this with `/plan` to get strong reasoning only when you need it—saving both time and credits.
:::
