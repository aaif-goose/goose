...
| [Yolo-Auto](https://yolo-auto.com/)                                         | Flat-rate inference gateway. OpenAI-compatible with streaming, function calling, and live model discovery from `https://yolo-auto.com/v1/models` once a key is set.                                                        | `YOLO_AUTO_API_KEY`, `YOLO_AUTO_HOST` (optional)                                                                                                                                    |
