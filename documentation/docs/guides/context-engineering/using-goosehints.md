...
<ol>
  <li>
    <details>
      <summary><code>my-project/.goosehints</code> (project root)</summary>
...
```
  ...
  <li>
    <details>
      <summary><code>frontend/.goosehints</code></summary>
...
```
  ...
  <li>
    <details>
      <summary><code>frontend/components/.goosehints</code> (current directory)</summary>
