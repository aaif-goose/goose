...
You can also ask goose what skills are available, or use the `/skills` command in a session to list available skills and load one or more by name (e.g. `/skills code-review edge-case-finder`).
