// Icon.jsx — lucide-style SVG icons. Stroke icons, 1.75 weight, rounded joins.
...
const Icon = ({ name, size = 16, style, className }) => {
  ...
  switch (name) {
    ...
    case 'sidebar-left': return <svg {...common}><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg>;
    case 'sidebar-right': return <svg {...common}><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="15" y1="3" x2="15" y2="21"/></svg>;
    case 'panel-toggle': return <svg {...common}><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg>;
