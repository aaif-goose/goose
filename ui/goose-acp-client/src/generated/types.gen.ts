...
export type ClientExtensionsListRequest_unstable = {
    [key: string]: unknown;
};

export type ClientExtensionsListResponse_unstable = {
    installDir: string;
    extensions: Array<ClientExtensionInfo>;
};

export type ClientExtensionInfo = {
    id: string;
    version: string;
    directory: string;
    source: ClientExtensionSourceKind;
    enabled: boolean;
    manifest: unknown;
};

export type ClientExtensionSourceKind = 'installed' | 'dev';

export type ClientExtensionsInstallRequest_unstable = {
    sourcePath: string;
};

export type ClientExtensionsInstallResponse_unstable = {
    installedId: string;
    installDir: string;
    extensions: Array<ClientExtensionInfo>;
};

export type ClientExtensionsSetEnabledRequest_unstable = {
    id: string;
    enabled: boolean;
};

export type ClientExtensionsUninstallRequest_unstable = {
    id: string;
};

export type ClientExtensionsReadMainRequest_unstable = {
    id: string;
};

export type ClientExtensionsReadMainResponse_unstable = {
    html: string;
};
