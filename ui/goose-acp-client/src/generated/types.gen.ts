...
export type ProjectCostAggregateRequest_unstable = {
    [key: string]: unknown;
};

export type ProjectCostAggregateResponse_unstable = {
    projects: Array<ProjectCostEntry>;
};
