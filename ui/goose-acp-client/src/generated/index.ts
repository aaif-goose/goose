...
export const GOOSE_EXT_METHODS = [
  ...
  {
    method: "_goose/unstable/providers/enablement/set",
    requestType: "ProviderEnablementSetRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
