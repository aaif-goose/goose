...
export const CONTEXT_FOLDERS: ContextFolder[] = [
  { id: "memory", name: "Memory", kind: "default", desc: "Shared across everything" },
  { id: "proj-talos", name: "Talos UI", kind: "project" },
...
export const CHATS: Chat[] = [
  ...
  { id: "c2", title: "PRD review — Talos workspace shell", group: "today", when: "2h ago", pinned: true, project: "proj-talos" },
  ...
  { id: "c7", title: "Plugin contract sketch", group: "yesterday", when: "Yesterday", project: "proj-talos" },
  ...
  { id: "c10", title: "Dark theme audit", group: "yesterday", when: "Yesterday", project: "proj-talos" },
  ...
  { id: "c18", title: "Token counter UX exploration", group: "older", when: "Apr 12", project: "proj-talos" },
  ...
  { id: "c22", title: "Ribbon icon set decision", group: "older", when: "Apr 2", project: "proj-talos" },
];

export const PROJECTS: Project[] = [
  { id: "proj-talos", name: "Talos UI", color: "violet", chats: ["c2", "c7", "c10", "c18", "c22"], notes: ["n1", "n5"] },
...
export const NOTES: Record<string, Note> = {
  n1: {
    id: "n1",
    title: "Talos plugin contract",
    kind: "wiki",
    updated: "2h ago",
    words: 412,
    body: [
      { type: "h1", text: "Talos plugin contract" },
      { type: "meta" },
  ...
  n4: {
    ...
    body: [
      ...
      { type: "meta" },
      { type: "p", text: "Shipped the PRD draft for Talos. Found a nasty WebSocket race condition — three getClient() calls in parallel opened three sockets. Fix in progress." },
      { type: "ul", items: [
  ...
  n6: {
    ...
    body: [
      ...
      { type: "meta" },
      { type: "p", text: "Talos follows the Obsidian-ish convention: ⌘+letter for primary actions, ⌘⇧+letter for paired or inverse actions. ⌘K is reserved for the command palette." },
    ],
  },
  n7: {
    id: "n7",
...
export const SESSION_NOTES_BY_CHAT: Record<string, string[]> = {
  c1: ["n2", "n3"],
  c2: ["n1", "n5"],
  c3: ["n7"],
  c4: ["n2"],
